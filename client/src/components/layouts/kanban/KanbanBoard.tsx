...
function KanbanBoard() {
  ...
  return (
    <Container maxWidth="lg" sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', py: 4 }}>
      <DndContext
        sensors={sensors}
